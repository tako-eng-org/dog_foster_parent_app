...
type User struct {
	...
	UserName       string `gorm:"type:varchar(20);	unique	not null"`  //ユーザー名
	...
	UserNickname   string `gorm:"type:varchar(30);					"`             //ニックネーム
	UserProfile    string `gorm:"type:varchar(400);					"`            //自己紹介文
